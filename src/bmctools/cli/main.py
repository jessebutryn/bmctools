...
Environment Variables:
  ...
  BMC_MANUFACTURER  Force manufacturer (asus, dell, supermicro, gigabyte, hpe, cisco, aivres, lenovo)
...
"""
    ...
    parser.add_argument('-m', '--manufacturer',
                       choices=['asus', 'dell', 'supermicro', 'gigabyte', 'hpe', 'hp', 'cisco', 'aivres', 'lenovo'],
